...
export const APIS = [DeviceCredentialControllerService, DispatcherSessionControllerService, FleetStateControllerService, GeofenceControllerService, MqttCredentialsControllerService, VehicleTrackControllerService];
